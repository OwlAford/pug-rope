...
$(function () {
  ...
  // 堆积条形图1
  toolkit.push('bar1', getHeapBarOptions());

  // 南丁格尔玫瑰图2
  toolkit.push('rose2', getRoseOptions({
    name: '本月盈利',
    radius: [20, 100],
    data: [{
      value: 10,
  ...
  // 折线图1
  toolkit.push('line1', getLineOptions(
    ['平均在线', '峰值在线'],
  ...
  // 折线图2
  toolkit.push('line2', getLineOptions(
    ['平均在线', '峰值在线'],
    ['00', '03', '06', '09', '12', '15', '18', '21', '24', '27', '30'],
    [{
      itemStyle: {
  ...
  // 南丁格尔玫瑰图3
  toolkit.push('rose3', getRoseOptions({
    name: '当日总注单量',
    radius: [25, 120],
    data: [{
      value: 10,
  ...
  // 南丁格尔玫瑰图4
  toolkit.push('rose4', getRoseOptions({
    name: '当日总投注',
    radius: [25, 120],
    data: [{
      value: 10,
  ...
  // 条形图2
  toolkit.push('bar2', getBarOptions());
